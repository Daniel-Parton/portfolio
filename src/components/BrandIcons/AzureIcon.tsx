...
export const AzureColor = '#121212';

export const AzureIcon = (props: Omit<BrandIconProps, 'viewBox'>) => {
  return (
    <BrandIcon {...props}>
      <defs>
        <linearGradient
          ...
          y1="145.312"
          y2="65.426"
          gradientTransform="matrix(0.25 0 0 -0.25 268.75 39.5)"
...
export const AzureMarqueeItem = () => {
  return (
    <BrandIconMarqueeItem
      icon={AzureIcon}
      label="Microsoft Azure"
      brandColor={AzureColor}
      textColor="white"
    />
  );
};
